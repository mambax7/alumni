 ...
 * Class Skill
 */
class Skill extends \XoopsObject
{
    /**
     * Constructor
     */
 ...
 * Class SkillHandler
 */
class SkillHandler extends \XoopsPersistableObjectHandler
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct($db, 'alumni_skills', Skill::class, 'skill_id', 'name');
    }
     ...
     * @return Skill|null Skill object
     */
